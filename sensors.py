...
while True:
	...
	#Print values
	print("MAGNETIC FIELD\t| ENVIRONMENTAL CONDITIONS\t|")
	print("X-axis: %d\t|" %xMag + " Temperature: %0.1f C" %bme280.temperature)
	print("Y-axis: %d\t|" %yMag + " Humidity: %0.1f %%" %bme280.humidity)
	print("Z-axis: %d\t|" %zMag + " Pressure: %0.1f kPa" %(bme.pressure*0.1)")
	print("Magnetic object: %d\t|\n" %Mag + " Altitude: %0.2f meters" %bme.280.altitude)
